...
const CartPage = () => {
  ...
  const handleCheckout = async () => {
    try {
      ...
      const options = {
        key: "rzp_test_tiX5llEj100TGy", // Replace with your Razorpay Key ID
    ...
    <div style={{ width: "100vw" }}>
      ...
      <div className="cart-container">
        <div className="cart-page">
          <a href="/customerhome" className="back-button" onClick={(e) => {
            e.preventDefault(); // Prevent default anchor behavior
            navigate("/customerhome"); // Navigate using React Router
          }}>
            ← Continue Shopping
          </a>
